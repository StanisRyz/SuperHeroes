...
const EVOLUTIONS: Array[Dictionary] = [
	...
	{"id": "mighty_clap_rampage_impact", "title": "Rage Field", "description": "Static Field becomes a Rage-scaling damage aura with larger and faster pulses at high Rage.", "target_type": "passive", "target_passive_id": "static_field", "implementation_status": "placeholder", "prerequisites": ["splash_melee_combo", "battle_focus", "mighty_clap_shockwave"]},
