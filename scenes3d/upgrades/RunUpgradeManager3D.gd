...
func apply_upgrade(upgrade_id: String) -> void:
	...
	if level >= int(UPGRADES[upgrade_id]["max_level"]):
		return
	if upgrade_id in ["static_field", "battle_focus", "magnet_core", "guardian_drone", "orbit_shields", "storm_relay", "chain_lightning"]:
...
func _has_dependencies(upgrade_id: String) -> bool:
	...
	if upgrade_id in ["splash_melee_combo", "splash_melee_lifesteal", "splash_melee_execute"]:
		return _auto_attack != null
	if upgrade_id in ["static_field", "battle_focus", "magnet_core", "guardian_drone", "orbit_shields", "storm_relay", "chain_lightning", "recovery_field"]:
