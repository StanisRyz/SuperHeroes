...
var _stages: Array[Dictionary] = [
	...
	},
	{
		...
		"threat_summary": "Ranged support pressure and lab-controlled enemy surges.",
		"stage_goal": "Survive 10:00 while managing ranged support, then defeat the Prism Overlord.",
		"recommended_playstyle": "Mobility, line control, and priority targeting help stabilize the lab.",
	...
	},
	{
		...
		"difficulty_label": "Hard",
		"threat_summary": "Exploder and swarm pressure closes space quickly.",
		"stage_goal": "Survive 10:00 through swarm pressure, then defeat the Molten Colossus.",
		"recommended_playstyle": "Area damage, close control, and durable builds handle the siege.",
