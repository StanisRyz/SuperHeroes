...
func setup(new_player: Node, new_auto_attack: Node, new_enemy_container: Node, new_pickup_container: Node, new_floating_text_spawner: Node = null, new_audio_manager: Node = null) -> void:
	player = new_player
...
func _apply_shield(world_position: Vector2) -> void:
	...
	_show_text("SHIELD", world_position)
...
func _apply_bomb(world_position: Vector2) -> void:
	...
	_show_text("BOMB", world_position)
...
func _apply_magnet_burst(world_position: Vector2) -> void:
	...
	_show_text("MAGNET", world_position)
...
func _apply_move_speed_boost(world_position: Vector2) -> void:
	...
	_show_text("SPEED", world_position)
...
func _apply_attack_speed_boost(world_position: Vector2) -> void:
	...
	_show_text("HASTE", world_position)


func _show_text(text: String, world_position: Vector2) -> void:
	if floating_text_spawner != null and floating_text_spawner.has_method("show_pickup"):
		floating_text_spawner.show_pickup(text, world_position)
