...
var _heroes: Array[Dictionary] = [
	{
		...
		"primary_weapon": {
			"weapon_id": "solar_bolt",
			"display_name": "Solar Bolt",
			"projectile_speed": 340.0,
			"projectile_size_multiplier": 1.35,
			"projectile_pierce": 0,
		},
	...
	},
	{
		...
		"primary_weapon": {
			"weapon_id": "gadget_darts",
			"display_name": "Gadget Darts",
			"projectile_speed": 640.0,
			"projectile_size_multiplier": 0.8,
			"projectile_bounce": 1,
		},
