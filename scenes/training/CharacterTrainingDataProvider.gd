...
func _build_nodes() -> void:
	_training_nodes = [
		_make_node("guardian_radiant_vitality", "guardian", "Radiant Vitality", "stats", "hero_stats", "max_health", 5.0, 50, 1.25, ["health", "guardian"], "Increases Solar Guardian max health.", 10),
		...
		_make_node("blaster_field_conditioning", "blaster", "Field Conditioning", "stats", "hero_stats", "max_health", 5.0, 50, 1.25, ["health", "blaster"], "Increases Night Tactician max health.", 10),
		...
		_make_node("vanguard_battle_conditioning", "vanguard", "Battle Conditioning", "stats", "hero_stats", "max_health", 5.0, 50, 1.25, ["health", "vanguard"], "Increases Fury Vanguard max health.", 10),
