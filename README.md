...
The project is currently in the foundation stage. It has the first playable loop pieces, but no attacks, XP, upgrades, HUD, mobile controls, or Yandex SDK integration yet.
